...
public class HotFragment    extends Fragment implements BookmarkCallback {
    View rootView;
    ...
    private void bindData() {
        ...
        placesTable =db.getReference().child(getString(R.string.DB_Places));
        loadMenu();
    }
    ...
    private void loadMenu() {
        ...
        query = placesTable.orderByChild("tag").equalTo("hot");
